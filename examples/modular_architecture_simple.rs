...
fn demo_message_bus() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("     • {}: {} capabilities", execution_layer.layer_id, execution_layer.capabilities.len());
    println!("     • {}: {} capabilities", consensus_layer.layer_id, consensus_layer.capabilities.len());
    println!("     • {}: {} capabilities", settlement_layer.layer_id, settlement_layer.capabilities.len());
    ...
    println!("     • {} ({:?} priority) from {:?}", health_message.id, health_message.priority, health_message.source_layer);
    println!("     • {} ({:?} priority) from {:?}", block_proposal.id, block_proposal.priority, block_proposal.source_layer);
    ...
    println!("     • Message bus instance created: {:p}", message_bus.as_ref());
